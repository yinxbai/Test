...
import com.txdata.common.utils.HttpContextUtils;
import com.txdata.common.utils.IPUtils;
import com.txdata.common.utils.JSONUtils;
import com.txdata.common.utils.ShiroUtils;
import com.txdata.system.domain.UserDO;

/**
 * 访问日志保存切面 对有@Log注解的方法访问时保存访问日志
 * 
 * @author huangmk
 * @since 2018-11-21
 *
...
public class LogAspect {
	...
	@Pointcut("@annotation(com.txdata.common.annotation.Log)")
