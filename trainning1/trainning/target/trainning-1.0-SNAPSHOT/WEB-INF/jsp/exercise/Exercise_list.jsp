          ...
          <form action="${pageContext.request.contextPath}/courseResource/batchDelete" method="post" id="form">
            <table class="table table-hover">
              ...
              <tr>
                ...
                <th>序号</th>
                <th class="hidden-xs w-15">doc</th>
                <th class="hidden-xs w-15">学生姓名</th>
                <th class="hidden-xs w-15">创建时间</th>
                <th class="text-center" style="width: 100px;">成绩</th>
              </tr>
              </thead>
              <tbody>
              <c:forEach items="${pageInfo.list}" var="s" varStatus="v">
                <tr >
                  ...
                  <td class="hidden-xs">${s.studentId.name}</td>
                  <td class="hidden-xs">${s.createTime}</td>
                  <td class="hidden-xs">${s.score}</td>
                  <td class="text-center">
                    <div class="btn-group">
                      <button class="btn btn-app-cyan">修改</button>
                      <button class="btn btn-app-teal">提交</button>
                    </div>
                  </td>
                </tr>
              </c:forEach>
