package com.txdata.blog.controller;
...
public class ContentController extends BaseController {
	...
	String edit(@PathVariable("cid") String cid, Model model) {
	...
	public R save(ContentDO bContent) {
		...
		bContent.setCreateDate(new Date());
		bContent.setUpdateDate(new Date());
		int count;
		if (bContent.getId() == null || "".equals(bContent.getId())) {
