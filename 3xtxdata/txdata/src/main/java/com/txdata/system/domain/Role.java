...
//	private List<User> userList = Lists.newArrayList(); // 拥有用户列表
	...
	public Role(AjaxRole ajaxRole) {
		this.id = ajaxRole.getId();
		this.name = ajaxRole.getName();
		this.enname = ajaxRole.getEnname();
		this.roleType = ajaxRole.getRoleType();
		this.dataScope = ajaxRole.getDataScope();
		this.sysData = ajaxRole.getSysData();
		this.useable = ajaxRole.getUseable();
		String menuIds = ajaxRole.getMenuIds();
		String officeIds = ajaxRole.getOfficeIds();
		this.setMenuIds(menuIds);
		this.setOfficeIds(officeIds);
		Office office = new Office(ajaxRole.getOfficeId());
		this.office = office;
		this.delFlag = DEL_FLAG_NORMAL;
		this.remarks = ajaxRole.getRemarks();
		this.oldName = ajaxRole.getOldName();
		this.oldEnname = ajaxRole.getOldEnname();
	}
